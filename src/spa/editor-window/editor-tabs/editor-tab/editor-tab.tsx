...
import { closeFile, selectFile } from '../../../shared/file-directory/file-directory-actions';
import { FileStatus } from '../../../shared/enums/file-status';

import './editor-tab.less';
import { IEditorTabProps, IEditorTabState, IEditorTabPassedProps, IEditorTabDispatchProps, IEditorTabReduxProps } from './editor-tab-models';
